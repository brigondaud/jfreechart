...
public class CrosshairOverlay extends AbstractOverlay implements Overlay,
    ...
    private transient CrosshairOverlayOperations anchor = new CrosshairOverlayOperations();
    ...
    public void paintOverlay(Graphics2D g2, ChartPanel chartPanel) {
        ...
        for (Crosshair ch : getDomainCrosshairs()) {
            if (ch.isVisible()) {
                ...
                if (plot.getOrientation() == PlotOrientation.VERTICAL) {
                    anchor.drawVerticalCrosshair(g2, dataArea, xx, ch);
                }
                else {
                    anchor.drawHorizontalCrosshair(g2, dataArea, xx, ch);
                }
            }
        }
        ...
        for (Crosshair ch : getRangeCrosshairs()) {
            if (ch.isVisible()) {
                ...
                if (plot.getOrientation() == PlotOrientation.VERTICAL) {
                    anchor.drawHorizontalCrosshair(g2, dataArea, yy, ch);
                }
                else {
                    anchor.drawVerticalCrosshair(g2, dataArea, yy, ch);
                }
            }
        }
    ...
    protected void drawHorizontalCrosshair(Graphics2D g2, Rectangle2D dataArea,
        ...
        anchor.drawHorizontalCrosshair(g2, dataArea, y, crosshair);
    }
    ...
    protected void drawVerticalCrosshair(Graphics2D g2, Rectangle2D dataArea,
        ...
        anchor.drawVerticalCrosshair(g2, dataArea, x, crosshair);
    }
    ...
    public Object clone() throws CloneNotSupportedException {
		...
		clone.anchor = (CrosshairOverlayOperations) this.anchor.clone();
	...
	private void readObject(java.io.ObjectInputStream stream)
		...
		this.anchor = (CrosshairOverlayOperations) stream.readObject();
	}

	private void writeObject(java.io.ObjectOutputStream stream) throws java.io.IOException {
		stream.defaultWriteObject();
		stream.writeObject(this.anchor);
	}
